...
# --- Configuration ---
DATA_CACHE_TTL_SECONDS = 7 # Fetch data max every 15 seconds (Adjust as needed)
APP_REFRESH_INTERVAL_SECONDS = 15 # Rerun UI every 5 seconds (Requires st_autorefresh or similar)
